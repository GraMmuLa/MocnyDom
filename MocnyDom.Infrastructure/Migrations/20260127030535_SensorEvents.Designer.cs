...
namespace MocnyDom.Infrastructure.Migrations
{
    ...
    [Migration("20260127030535_SensorEvents")]
    partial class SensorEvents
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MocnyDom.Domain.Entities.Building", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MocnyDom.Domain.Entities.Floor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MocnyDom.Domain.Entities.Room", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MocnyDom.Domain.Entities.Room", b =>
                {
                    b.HasOne("MocnyDom.Domain.Entities.Floor", "Floor")
                        .WithMany("Rooms")
            ...
            modelBuilder.Entity("Sensor", b =>
                {
                    b.HasOne("MocnyDom.Domain.Entities.Room", "Room")
                        .WithMany()
